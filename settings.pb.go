...
func (*MapSettings) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{5} }
...
func (*GpsSettings) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{6} }
...
func (*NewsSettings) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{7} }
...
func (*NewsSettings_News) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{7, 0} }
...
func (*SfidaSettings) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{8} }
...
func (*EventSettings) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{9} }
...
func (*GlobalSettings) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{10} }
...
var fileDescriptor10 = []byte{
	...
	,
}
